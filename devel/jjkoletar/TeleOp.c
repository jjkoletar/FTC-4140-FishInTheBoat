...
conveyorBelt ()
{
  ...
  if (highConveyorPower)
    conveyorPower = 25;
  else
    conveyorPower = 15;
  //down/out = pos, in = neg
  if (joystickVal (2, "y1") > deadZone + 25
      && nMotorEncoder[conveyorArmMotor] > 1000)
    motor[conveyorMotor] = conveyorPower;
  else if (joystickVal (2, "y1") < deadZone - 25 && joystickVal (2, "y1") < 0
	   && nMotorEncoder[conveyorArmMotor] > 1000)
    motor[conveyorMotor] = -conveyorPower;
  else
...
drive ()
{
  ...
  //128  = all right
  //periouette handlers
  if (abs (joystick.joy1_y2) <= deadZone && abs (joystick.joy1_x1) > deadZone
      && turnToggle)
    {
      //periouette is on
...
driveSwapped ()
{
  ...
  //128  = all right
  //periouette handlers
  if (abs (joystick.joy2_y2) <= deadZone && abs (joystick.joy2_x1) > deadZone
      && turnToggle)
    {
      //periouette is on
...
watchJoySwap ()
{
  if ((joystickVal (1, "9") && joystickVal (1, "10"))
      || (joystickVal (2, "9") && joystickVal (2, "10")))
    {
      wait1Msec (2000);
      if ((joystickVal (1, "9") && joystickVal (1, "10"))
	  || (joystickVal (2, "9") && joystickVal (2, "10")))
...
holdGoalWatcher ()
{
  ...
  if (joystickVal (2, "hat") == 6)
    servo[leftGoalHolder] = 191;
  else if (joystickVal (2, "hat") == 2)
...
{
  if (joystickVal (1, "5"))
    servo[leftArm] = servo[leftArm] + 3;
  else if (joystickVal (1, "7"))
    servo[leftArm] = servo[leftArm] - 3;

  if (servo[leftArm] <= 25 && !joystickVal (1, "7"))
    servo[leftArm] = 25;

  if (joystickVal (1, "8"))
    servo[rightArm] = servo[rightArm] + 3;
  else if (joystickVal (1, "6"))
    servo[rightArm] = servo[rightArm] - 3;
